                ...
                <form id="frm_add_credit"  method="POST" action="upload.php">
                    ...
                    <div class="form-group">
                        ...
                        <select id="credit_type" name="credit_type" class="form-control">
                            <option value="WRITTEN">Written Based</option>
                            <option value="VIDEO">Video</option>
                        </select>
                    </div>
                    <div class="form-group video_div" style="display: none;">
                        <label class="col-md-2 control-label">
                        Video Url
                        </label>
                        <input id="video_url" name="video_url" type="text" class="form-control" required>
                    </div>
